...
public class TestCensus {
    ...
    @Test
    public void testCensusSingle_InvalidAge_Ignores() {
        AgeIteratorWrapper iterator =
        ...
        try {
            ...
            Assert.fail("Invalid ages aren't being treated.");
        } finally {
            assertTrue("Iterator hasn't been closed.", iterator.closed);
        }
    }
    ...
    @Test
    public void testCensusMultiple_InvalidAges_Ignores() {
        List<AgeIteratorWrapper> iterators =
                IntStream.range(0, 5)
                        .mapToObj(e -> registerIterator(new AgeIteratorWrapper(ImmutableList.of(2, -1, 2).iterator(), "invalidAge" + e)))
                        .collect(Collectors.toList());
        ...
        try {
            ...
            assertTrue("Invalid result null.", strings != null);
            System.out.println(Arrays.toString(strings));
            assertArrayEquals(new String[]{"1:2=10"}, strings);
        } catch (RuntimeException e) {
            Assert.fail("Invalid ages aren't being treated.");
        }
    }
    ...
    private Iterator<Integer> newPseudoRandomIterator(int n) {
        ...
        return IntStream.range(0, n).map(e -> {
            ...
            if (e < 1) {
                return 35; // Just so we have 10 and 35 as 84 (85!?) in total.
            }
